...
<script type="text/javascript">
	function doUpdateRole() {
		var url = "${ctx}/func/role/do_update_role";
				...
				<form id="roleForm">
					<div class="panel panel-default">
						...
						<div class="panel-footer">
							<a href="javascript:;" onclick="doUpdateRole();" class="btn btn-sm btn-primary pull-right publish" style="width: 100px; margin-left: 10px;">
