...
<body>
	<div class="row">
		<div class="col-lg-12 now_position">
			...
			&nbsp;首页&nbsp;/&nbsp;<fmt:message key="Parameter Mgmt." />/&nbsp;
			<c:if test="${type eq '3' }"><fmt:message key="allMonth.product" /></c:if>
			<c:if test="${type eq '4' }"><fmt:message key="spotMonth.commodity" /></c:if>
		</div>
	</div>
